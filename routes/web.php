...
Route::group(
    ...
    Route::group(
        ...
        Route::get('/{id}/update', 'App\Http\Controllers\GalleryController@update')->name('updateplaylist');
        Route::get('/{id}/delete', 'App\Http\Controllers\GalleryController@delete')->name('deleteplaylist');
        Route::post('/{id}/update/submit', 'App\Http\Controllers\GalleryController@updateSubmit')->name('updatesubmit');
        Route::post('/create/submit', 'App\Http\Controllers\GalleryController@add')->name('playlistcreateSubmit');
        Route::post('/create', 'App\Http\Controllers\GalleryController@api')->name('playlistAutocompleteSubmit');
    });
});
